...
//                        imgr[ii][jj]+=llr_bp_to_img(Lu_c[t_lvl][j+i*imgw],t_lvl);
                        imgr_soft_bp[ii][jj][t_lvl] = Lu_c[t_lvl][j+i*imgw] - Le_s[t_lvl][j+i*imgw];
                       // imgr_soft_bp[ii][jj][t_lvl] = exp(Lu_c[t_lvl][j+i*imgw] - Le_s[t_lvl][j+i*imgw]);
...
//                        imgr_prev[ii][jj]+=llr_bp_to_img(Lu_c_prev[t_lvl][j+i*imgw],t_lvl);
                        imgr_soft_bp_prev[ii][jj][t_lvl] = Lu_c_prev[t_lvl][j+i*imgw] - Le_s_prev[t_lvl][j+i*imgw];
                       // imgr_soft_bp_prev[ii][jj][t_lvl] = exp(Lu_c_prev[t_lvl][j+i*imgw]- Le_s_prev[t_lvl][j+i*imgw]);
                    }
