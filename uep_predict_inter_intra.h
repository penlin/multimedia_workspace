...
void weight_predict_Inter_Intra_minMSE(int** img, int** img_prev, int** img_nxt, const int &imgh, const int &imgw, double* weights, const double &gamma){
...
// for inter pair
void weight_predict_Inter_Intra_minMSE(int** img, int** img_ref,const int &imgh, const int &imgw, double* weights, const double &gamma){
...
double inter_intra_basic_psnr_est(int*** img_bp, int*** img_bp_ref, int** mv1, const int &imgh, const int &imgw, double* weights, const double &gamma){
...
double inter_intra_psnr_est(int*** img_bp, int*** img_bp_ref, int** mv1, const int &imgh, const int &imgw, double* weights, const double &gamma,double* frr_prev, int*** img_bp_ref2 = NULL, int** mv2 = NULL){
